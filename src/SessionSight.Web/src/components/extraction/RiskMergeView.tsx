    ...
    <div>
      ...
      {open && (
        <div className="mt-2 space-y-2">
          ...
          {diagnostics.contentFilterBlocked && (
            <div className="rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800">
              <span className="font-medium">Content Filter</span>
              <span className="ml-2">
                — Re-extraction was blocked by Azure OpenAI content filter.
                Risk fields show original extraction only (via conservative merge).
              </span>
            </div>
          )}
