...
public static class ExtractionPrompts
{
    ...
    public static string GetRiskAssessmentPrompt(string noteText) => """
        ...
        - Classification boundaries:
          ...
          * suicidalIdeation: Euphemistic or indirect language about ending one's life (e.g., "go to sleep and not wake up", "ready for the long rest", "be with [deceased person] again", "won't need to worry about that") combined with concrete preparatory behaviors (researching methods, asking about medication interactions, giving away possessions, canceling future commitments) should be classified as at minimum ActiveNoPlan — these patterns indicate planning despite absence of explicit suicide language.
