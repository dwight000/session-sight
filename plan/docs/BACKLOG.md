...
**Next Action**: P2-001 (AI extraction) or remaining CI/CD (B-026, P1-015)
...
| B-018 | Wire up 60% coverage enforcement in CI (raise to 80% later) | M | 1 | Done | P1-012, B-028 |
...
| B-018 | Coverage enforcement (60% threshold) | 2026-01-30 |
